...
public class Game {
    ...
    // и возвращает false, если такой двери нет
    ...
    public int giveHint() {
        //В этом списке двери без приза и которые не выбрал пользователь
    ...
    public void changeChoice() {
        ...
        if (currentSelectedDoor != null) currentSelectedDoor.setSelected(false);
        if (newSelectedDoor != null) newSelectedDoor.setSelected(true);
